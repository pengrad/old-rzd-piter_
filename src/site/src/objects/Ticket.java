...
public class Ticket {
    ...
    private int bl;           // 'Номер бланка',
    private String SN;        // 'СНИЛС',
    private Date timeCalcReport;
    ...
    public Date getTimeCalcReport() {
        return timeCalcReport;
    }

    public void setTimeCalcReport(Date timeCalcReport) {
        this.timeCalcReport = timeCalcReport;
    }
}
