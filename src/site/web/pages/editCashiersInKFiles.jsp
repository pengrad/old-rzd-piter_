...
<%
    ...
    ArrayList<Object[]> cashiers = (ArrayList<Object[]>) request.getAttribute("cashiers");
%>
<html>
<head>
...
<div id="data">
    ...
    <div>
        <div style="text-align:right;padding-right:10px">
            <input class="addCashiers" type="button" value="&nbsp;Добавить&nbsp;">
        </div>
        <%for (Object[] o : cashiers) {%>
        <div style="text-align:left;font-size:10pt;font-weight:bolder;">
            &nbsp;&nbsp;&nbsp;<%=((SegmentInfo) o[0]).getName()%>
        </div>
        <table class="tableRow" style="width:670px">
            <%for (Cashiers cash : ((ArrayList<Cashiers>) o[1])) {%>
            <tr>
                <td style="width:30px;">
                    <%=cash.getIdCashiers()%>
                </td>
