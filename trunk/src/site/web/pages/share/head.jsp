                ...
                <div id="content">
                    <div id="header">
                        <div class="hMenu">
                            <div>
                                <ul>
                                    <li class="first"><a href="<%=request.getContextPath()%>/3932/direction.htm">Администрирование</a></li>
                                    <li><a href="<%=request.getContextPath()%>/pages/report/graphics/gr1.jsp">Отчетность</a></li>
